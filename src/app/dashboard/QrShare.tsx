...
export function QrShare({ url }: { url: string }) {
  ...
  return (
    <div className="flex gap-2 flex-wrap">
      ...
      {navigator.share && <button onClick={() => navigator.share({ title: "Mon Bizko", url })} className="h-9 px-4 rounded-lg border border-gray-200 text-sm text-gray-700 hover:bg-gray-50">Partager</button>}
      {open && qr && (
