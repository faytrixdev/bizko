          ...
          <div className="space-y-2">
            {[
              ...
              >
                ...
                <div className="shrink-0 inline-flex items-center gap-1.5 h-8 px-3 rounded-xl bg-[#25D366] text-white text-xs font-semibold shadow-sm shadow-[#25D366]/20">
                  <svg
