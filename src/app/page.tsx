...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-[640px] mx-auto px-4 py-16 sm:py-20 flex flex-col items-center text-center">
        <div className="max-w-xl flex flex-col gap-5">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight leading-[0.95] font-display text-gray-900">
            Ton business
            <br />
            <span className="text-[#FF6B35]">en un lien.</span>
          </h1>
        ...
        <div className="mt-14 w-full max-w-[480px] rounded-xl border border-gray-200 bg-white p-5 text-left">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="ml-auto inline-flex h-7 items-center rounded-full bg-[#25D366] px-3 text-[11px] font-medium text-white">WhatsApp</span>
          </div>
          <div className="space-y-2">
            <div className="rounded-lg bg-gray-50 border border-gray-200 p-3 flex items-center justify-between">
              ...
              <div className="h-7 px-2.5 rounded-lg bg-gray-900 text-white text-[11px] font-medium flex items-center">Demander</div>
            </div>
      ...
      <footer className="py-6 text-center text-xs text-gray-400">Bizko 2026</footer>
    </div>
  );
}
